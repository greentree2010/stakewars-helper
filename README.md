...
|             |             |
| ----------- | ----------- |
| Welcome to Stake Wars: Episode III A New Validator. Stake Wars is a program that helps the community become familiar with what it means to be a NEAR validator, and gives the community an early chance to access the chunk-only producer. Stake Wars offers rewards that support new members who want to join mainnet as a validator starting from the end of September 2022. I hope this document will be with you! | <img src="images/near.jpg" alt="near_icon" width="200"/>      |
## Quick links
